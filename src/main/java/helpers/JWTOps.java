...
/**
 * Class deals with different JWT operations (Generation, signing, verification)
 */
public class JWTOps {
    ...
    public static String createJWT(String subject, String issuer, String clientRole, String clientLogin, String clientDisplayName, long expirationMinutes, String secretKeyBase64Encoded) {
        ...
        Key key = Keys.hmacShaKeyFor(secretKeyBase64Encoded.getBytes(StandardCharsets.UTF_8));
     ...
     * If the token is invalid or expired, it will throw a JwtException.
     */
    public static Claims verifyJWT(String token, String secretKeyBase64Encoded) {
        SecretKey KEY = Keys.hmacShaKeyFor(secretKeyBase64Encoded.getBytes(StandardCharsets.UTF_8));
